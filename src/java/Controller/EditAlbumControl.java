 ...
 * @author Ryuu
 */
@WebServlet(name = "EditAlbumControl", urlPatterns = {"/editAlb"})
public class EditAlbumControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String albID = request.getParameter("alb");
        Album alb = albumDAO.checkAlbumByID(albID);
