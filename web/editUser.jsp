<%-- 
    Document   : editUser
    Created on : Mar 13, 2021, 8:18:39 PM
    Author     : Ryuu
--%>
                            ...
                            <div class="d-flex align-items-start navtab">
                                ...
                                <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade show active tab-panel" id="v-pills-profile" role="tabpanel" >
                                        <form action="confirmU" method="post" class="tab-form profile-form">
                                            <div class="profileName tab-container">
                                                <c:if test="${acE.isUser == 1}">
                                                    <div class="tab-input-content">
                                                        <p class="warning" >Account permisson is Member</p>
                                                    </div>
                                                </c:if>
                                                <c:if test="${acE.isAdmin == 1}">
                                                    <div class="tab-input-content">
                                                        <p class="warning" >Account permisson is Admin</p>
                                                    </div>
                                                </c:if>
                                                <div class="tab-wrong tab-input-content">
                                                    <p class="wrong">${checkU}</p>
                                                </div>
                                                <div class="tab-input-content">
                                                    <h6>User Name</h6>
                                                    <input name="idU" class="tab-input" type="tel" name="profileName" value="${acE.uid}" hidden=""/>
                                                    <input name="nameU" class="tab-input" type="text" name="profileName" placeholder="${acE.name}" value="${acE.name}"/>
                                                </div>
                                                <div class="tab-input-content">
                                                    <h6>User isAdmin</h6>
                                                    <input name="isAdmin" class="tab-input" type="text" name="profileName" value="${acE.isAdmin}"/>
                                                </div>
                                                <div class="tab-input-content">
                                                    <h6>User isMember</h6>
                                                    <input name="isUser" class="tab-input" type="text" name="profileName" value="${acE.isUser}"/>
                                                </div>
                                                <div class="tab-input-content">
                                                    <h6>User Mail</h6>
                                                    <input name="email" class="tab-input" type="text" name="profileName" placeholder="${acE.email}" />
                                                </div>
